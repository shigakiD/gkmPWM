...
static void t_binary_expand_op(emxArray_real_T *kweig, int i1, int i2, int i3,
      ...
      if ((b_i != M - 1.0) || (b_i2 + 1 <= rx) || (b_i2 + 1 == m)) {
          ...
          if (indloc_data[(int)indvec_data[(int)b_i3 - 1] - 1] == 0.0) {
            ...
            if (indloc_data[(int)indvec_data[(int)(b_i3 - 1.0) - 1] - 1] ==
              ...
              if (r->size[0] == y->size[0]) {
                ...
                p_binary_expand_op(ktree, b_i3, r, y);
                ktree_data = ktree->data;
              }
            }
          } else {
        ...
        if (b_i2 + 1 <= rx) {
          ...
          for (j = 0; j < i1; j++) {
            ...
            if (varargin_1 != 0.0) {
              ...
              if (i2 - b_k == ktree_data[(int)k - 1].f1->size[0]) {
                ...
                t_binary_expand_op(kweig, ibcol, b_k, i2 - 1, ktree, k, nrows,
                                   ibcol - 1);
                kweig_data = kweig->data;
              }
            }
          ...
          if (b_k - i1 == ktree_data[(int)k - 1].f1->size[0]) {
            ...
            t_binary_expand_op(kweig, i2, i1, b_k - 1, ktree, k, ibcol, i2 - 1);
            kweig_data = kweig->data;
          }
        }
      }
