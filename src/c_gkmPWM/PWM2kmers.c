...
static void n_binary_expand_op(emxArray_cell_wrap_14 *KC,
...
static void o_binary_expand_op(emxArray_cell_wrap_14 *KC,
                               const emxArray_real_T *ind, int i2,
                               const emxArray_cell_wrap_14 *ktree, double k,
                               const emxArray_cell_wrap_14 *ktree2);

static void p_binary_expand_op(emxArray_real_T *kweig, double n);
               ...
               emxArray_real_T *kweig)
{
      ...
      if ((b_i != M - 1.0) || (b_i2 + 1 <= rx) || (b_i2 + 1 == m)) {
          ...
          if (indloc_data[(int)indvec_data[(int)b_i3 - 1] - 1] == 0.0) {
            ...
            if (indloc_data[(int)indvec_data[(int)(b_i3 - 1.0) - 1] - 1] ==
              ...
              if (r->size[0] == repmatt->size[0]) {
                ...
                m_binary_expand_op(ktree, b_i3, r, repmatt);
                ktree_data = ktree->data;
              }
              ...
              if (r->size[0] == repmatt->size[0]) {
                ...
                m_binary_expand_op(ktree2, b_i3, r, repmatt);
                ktree2_data = ktree2->data;
              }
            }
          } else {
        ...
        if (b_i2 + 1 <= rx) {
          ...
          for (j = 0; j < i1; j++) {
            ...
            if (x_data[b_i2 + x->size[0] * j] != 0.0) {
              ...
              if ((r->size[0] == ktree_data[(int)k - 1].f1->size[0]) &&
                ...
                n_binary_expand_op(KC, ind, x, b_i2, j, r, ktree, k, ktree2);
                KC_data = KC->data;
              }
          ...
          if ((KC_data[(int)ind_data[b_i2] - 1].f1->size[0] ==
            ...
            o_binary_expand_op(KC, ind, b_i2, ktree, k, ktree2);
            KC_data = KC->data;
          }
  ...
  if (kweig->size[0] != (int)n) {
    p_binary_expand_op(kweig, n);
  }
}

void m_binary_expand_op(emxArray_cell_wrap_14 *ktree2, double i3,
                        const emxArray_real_T *r1,
