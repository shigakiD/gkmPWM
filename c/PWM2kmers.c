...
static void o_binary_expand_op(emxArray_cell_wrap_3 *KC,
...
static void p_binary_expand_op(emxArray_cell_wrap_3 *KC,
                               const emxArray_real_T *ind, int i2,
                               const emxArray_cell_wrap_3 *ktree, double k,
                               const emxArray_cell_wrap_3 *ktree2);

static void q_binary_expand_op(emxArray_real_T *kweig, double n);
      ...
      if ((b_i != M - 1.0) || (b_i2 + 1 <= rx) || (b_i2 + 1 == m)) {
        ...
        for (i1 = 0; i1 < idx; i1++) {
          for (i2 = 0; i2 < loop_ub; i2++) {
            sPWM_data[i2 + sPWM->size[0] * i1] =
                mat_data[((int)repmatt_data[i1] + mat->size[0] * i2) - 1];
          }
        }
        ...
        for (i1 = 0; i1 < idx; i1++) {
          for (i2 = 0; i2 < loop_ub; i2++) {
            sPWM2_data[i2 + sPWM2->size[0] * i1] =
                mat2_data[((int)repmatt_data[i1] + mat2->size[0] * i2) - 1];
          }
        }
          ...
          if (indloc_data[(int)indvec_data[(int)b_i3 - 1] - 1] == 0.0) {
            ...
            if (indloc_data[(int)indvec_data[(int)(b_i3 - 1.0) - 1] - 1] ==
              ...
              for (j = 0; j < 4; j++) {
                ...
                for (ni = 0; ni < idx; ni++) {
                  repmatt_data[ni] =
                      ktree_data[(int)(b_i3 - 1.0) - 1].f1->data[ni] * alen;
                }
                 ...
                 * = ktree2{i3-1}*matt(i4); */
                d1 = (((double)j + 1.0) - 1.0) * pow(4.0, b_i3 - 1.0) + 1.0;
                d2 = pow(4.0, b_i3 - 1.0) * ((double)j + 1.0);
                if (d1 > d2) {
                  i2 = -1;
                  ni = 0;
                } else {
                ...
                for (ni = 0; ni < idx; ni++) {
                  repmatt_data[ni] =
                      ktree2_data[(int)(b_i3 - 1.0) - 1].f1->data[ni] * matt[j];
                }
                loop_ub = b_ktree->size[1];
                for (ni = 0; ni < loop_ub; ni++) {
               ...
               */
              c_repmat(ktree_data[(int)(b_i3 - 1.0) - 1].f1, b_r);
              r1 = b_r->data;
              if (b_r->size[0] == repmatt->size[0]) {
                ...
                n_binary_expand_op(ktree, b_i3, b_r, repmatt);
                ktree_data = ktree->data;
              }
              /* 'PWM2kmers:60' ktree2{i3} = repmat(ktree2{i3-1}, 4,
               * 1).*repmatt; */
              c_repmat(ktree2_data[(int)(b_i3 - 1.0) - 1].f1, b_r);
              r1 = b_r->data;
              if (b_r->size[0] == repmatt->size[0]) {
                i2 = ktree2_data[(int)b_i3 - 1].f1->size[0];
                ktree2_data[(int)b_i3 - 1].f1->size[0] = b_r->size[0];
                ...
                n_binary_expand_op(ktree2, b_i3, b_r, repmatt);
                ktree2_data = ktree2->data;
              }
            }
          } else {
            ...
            for (i2 = 0; i2 < loop_ub; i2++) {
              ...
              for (ni = 0; ni < idx; ni++) {
                repmatt_data[ni + a->size[0] * i2] =
                    ...
                    sPWM_data[i2 + sPWM->size[0] * ((int)b_i3 - 1)];
              }
            }
            ...
            for (i2 = 0; i2 < loop_ub; i2++) {
              ...
              for (ni = 0; ni < idx; ni++) {
                repmatt_data[ni + a->size[0] * i2] =
                    ...
                    sPWM2_data[i2 + sPWM2->size[0] * ((int)b_i3 - 1)];
              }
            }
            /* 'PWM2kmers:66' ktree2{i3} = a(:); */
            i2 = ktree2_data[(int)b_i3 - 1].f1->size[0];
            ktree2_data[(int)b_i3 - 1].f1->size[0] = a->size[0] * a->size[1];
            emxEnsureCapacity_real_T(ktree2_data[(int)b_i3 - 1].f1, i2);
            loop_ub = a->size[0] * a->size[1];
            for (i2 = 0; i2 < loop_ub; i2++) {
        ...
        if (b_i2 + 1 <= rx) {
            ...
            if (x_data[b_i2 + x->size[0] * j] != 0.0) {
              ...
              b_r->size[0] =
                  KC_data[(int)
                          ...
                          1]
                      .f1->size[0];
              emxEnsureCapacity_real_T(b_r, i2);
              r1 = b_r->data;
              loop_ub =
                  KC_data[(int)
                              ind_data[(int)x_data[b_i2 + x->size[0] * j] - 1] -
              ...
              if ((b_r->size[0] == ktree_data[(int)k - 1].f1->size[0]) &&
                ...
                o_binary_expand_op(KC, ind, x, b_i2, j, b_r, ktree, k, ktree2);
                KC_data = KC->data;
              }
          ...
          if ((KC_data[(int)ind_data[b_i2] - 1].f1->size[0] ==
            ...
            p_binary_expand_op(KC, ind, b_i2, ktree, k, ktree2);
            KC_data = KC->data;
          }
