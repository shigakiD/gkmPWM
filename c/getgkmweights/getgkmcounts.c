                  ...
                  double mat[16], double mat2[16])
{
  ...
  cell_wrap_1 C[8];
  cell_wrap_6 validatedHoleFilling[3];
  cell_wrap_6 r;
  cell_wrap_6 r1;
  cell_wrap_7 *sequences_data;
  emxArray_boolean_T *b_x;
  emxArray_boolean_T *c_x;
  emxArray_cell_wrap_7 *sequences;
  ...
  emxInitMatrix_cell_wrap_61(validatedHoleFilling);
  ...
  if (vlen != -1) {
    ...
    if (vlen != -1) {
      ...
      emxEnsureCapacity_cell_wrap_7(sequences, i);
      ...
      for (loop_ub = 0; loop_ub < vlen; loop_ub++) {
        ...
        emxCopyStruct_cell_wrap_6(&sequences_data[loop_ub].f1[0], &r);
      }
      ...
      for (loop_ub = 0; loop_ub < vlen; loop_ub++) {
         ...
         */
        fgetl(fileid, r1.f1);
        emxCopyStruct_cell_wrap_6(&sequences_data[loop_ub].f1[0], &r1);
      }
  ...
  *GCneg = 0.0;
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (RC != 0.0) {
      ...
      if (loop_ub == b_k - i2) {
        ...
        e_binary_expand_op(temp, loop_ub - 1, i2, b_k - 1);
        temp_data = temp->data;
      }
  ...
  emxFreeMatrix_cell_wrap_61(validatedHoleFilling);
  emxFree_real_T(&c_y);
  emxFree_int32_T(&r6);
  emxFree_real_T(&r4);
  emxFree_cell_wrap_7(&sequences);
  emxFree_real_T(&M);
  emxFreeMatrix_cell_wrap_1(C);
  emxFree_real_T(&ss);
  emxFree_real_T(&M2);
  emxFree_real_T(&Ker);
  emxFree_real_T(&x);
