...
void c_sprintf(const emxArray_char_T *varargin_1, int varargin_2,
               int varargin_3, int varargin_4, emxArray_char_T *str_Value)
{
  emxArray_char_T *b_varargin_1;
  emxArray_char_T *c_varargin_1;
  int i;
  ...
  c_varargin_1_data[varargin_1->size[1]] = '\x00';
  nbytes = snprintf(NULL, 0, "%s_%d_%d_%d", &c_varargin_1_data[0], varargin_2,
  ...
  emxEnsureCapacity_char_T(str_Value, i);
  c_varargin_1_data = str_Value->data;
  snprintf(&c_varargin_1_data[0], (size_t)(nbytes + 1), "%s_%d_%d_%d",
           &b_varargin_1_data[0], varargin_2, varargin_3, varargin_4);
  i = str_Value->size[0] * str_Value->size[1];
  if (1 > nbytes) {
    str_Value->size[1] = 0;
  } else {
