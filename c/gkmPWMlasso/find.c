                        ...
                        const emxArray_real_T *E)
{
  ...
  for (i = 0; i < loop_ub; i++) {
    b_indc_data[i] =
        (indc_data[i * stride_0_0] + E_data[i * stride_1_0] != 0.0);
  }
                        ...
                        const emxArray_real_T *lenvec, double varargin_5)
{
  ...
  for (i = 0; i < loop_ub; i++) {
    b_loc_data[i] =
        (loc_data[i * stride_0_0] / lenvec_data[i * stride_1_0] >= varargin_5);
  }
