...
make -f macos.mk
```
This takes less than a minute to install.  There will be three executables: gkmPWMlasso, gkmPWM, and mapTF that appear in the directory. If you are using a Windows environment, please either use the Matlab code or run the C code within Windows Subsystem for Linux.
